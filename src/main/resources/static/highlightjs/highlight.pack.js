...
!function (e) {
    ...
    var f = [], i = Object.keys, b = {}, u = {}, n = /^(no-?highlight|plain|text)$/i, l = /\blang(?:uage)?-([\w-]+)\b/i,
        t = /((^(<[^>]+>|\t|)+|(?:\n)))/gm, r = {
            case_insensitive: "cI",
            lexemes: "l",
            contains: "c",
            ...
            terminators: "t",
            terminator_end: "tE"
        }, _ = "</span>", m = {classPrefix: "hljs-", tabReplace: null, useBR: !1, languages: void 0},
    ...
    function R(n) {
        ...
        }(n) ? [s(n, {starts: n.starts ? s(n.starts) : null})] : [n]
    }
    ...
    function O(r) {
            ...
            return i = f(function (e, n) {
                for (var t = /\[(?:[^\\\]]|\\.)*\]|\(\??|\\([1-9][0-9]*)|\\./, r = 0, a = "", i = 0; i < e.length; i++) {
                    ...
                    for (0 < i && (a += n), a += "("; 0 < u.length;) {
                        ...
                        a += u.substring(0, l.index), u = u.substring(l.index + l[0].length), "\\" == l[0][0] && l[1] ? a += "\\" + String(Number(l[1]) + c) : (a += l[0], "(" == l[0] && r++)
                    }
                    a += ")"
                }
                return a
            }(o, "|"), !0), l.lastIndex = 0, l.exec = function (e) {
                var n;
                if (0 === u.length) return null;
                i.lastIndex = l.lastIndex;
                var t = i.exec(e);
                if (!t) return null;
                for (var r = 0; r < t.length; r++) if (null != t[r] && null != c["" + r]) {
                    n = c["" + r];
                    break
                }
        ...
        !function n(t, e) {
            t.compiled || (t.compiled = !0, t.k = t.k || t.bK, t.k && (t.k = p(t.k, r.cI)), t.lR = f(t.l || /\w+/, !0), e && (t.bK && (t.b = "\\b(" + t.bK.split(" ").join("|") + ")\\b"), t.b || (t.b = /\B|\b/), t.bR = f(t.b), t.endSameAsBegin && (t.e = t.b), t.e || t.eW || (t.e = /\B|\b/), t.e && (t.eR = f(t.e)), t.tE = s(t.e) || "", t.eW && e.tE && (t.tE += (t.e ? "|" : "") + e.tE)), t.i && (t.iR = f(t.i)), null == t.relevance && (t.relevance = 1), t.c || (t.c = []), t.c = Array.prototype.concat.apply([], t.c.map(function (e) {
                return R("self" === e ? t : e)
    ...
    function x(e, a, i, n) {
        ...
        function l() {
            R += null != g.sL ? function () {
                ...
                var e, n, t, r, a, i, c;
                if (!g.k) return C(v);
                for (r = "", n = 0, g.lR.lastIndex = 0, t = g.lR.exec(v); t;) r += C(v.substring(n, t.index)), a = g, i = t, void 0, c = E.cI ? i[0].toLowerCase() : i[0], (e = a.k.hasOwnProperty(c) && a.k[c]) ? (p += e[1], r += u(e[0], C(t[0]))) : r += C(t[0]), n = g.lR.lastIndex, t = g.lR.exec(v);
        ...
        function s(e) {
            ...
            }(n)), t.skip ? v += n : (t.eB && (v += n), l(), t.rB || t.eB || (v = n)), o(t), t.rB ? 0 : n.length
        }
        ...
        function t(e, n) {
            ...
            if ("begin" == f.type && "end" == n.type && f.index == n.index && "" === t) return v += a.slice(n.index, n.index + 1), 1;
            if ("begin" === (f = n).type) return s(n);
            if ("illegal" === n.type && !i) throw new Error('Illegal lexeme "' + t + '" for mode "' + (g.cN || "<unnamed>") + '"');
            if ("end" === n.type) {
                var r = function (e) {
                    var n = e[0], t = c(g, n);
                    if (t) {
                        var r = g;
                        for (r.skip ? v += n : (r.rE || r.eE || (v += n), l(), r.eE && (v = n)); g.cN && (R += _), g.skip || g.sL || (p += g.relevance), (g = g.parent) !== t.parent;) ;
        ...
        var v = "", p = 0;
        try {
            for (var M, N, h = 0; g.t.lastIndex = h, M = g.t.exec(a);) N = t(a.substring(h, M.index), M), h = M.index + N;
    ...
    function B(t, e) {
        e = e || m.languages || i(b);
        var r = {relevance: 0, value: C(t)}, a = r;
        return e.filter(S).filter(T).forEach(function (e) {
            var n = x(e, t, !1);
    ...
    function M(e) {
        return m.tabReplace || m.useBR ? e.replace(t, function (e, n) {
            return m.useBR && "\n" === e ? "<br>" : m.tabReplace ? n.replace(/\t/g, m.tabReplace) : ""
        }) : e
    }

    function N(e) {
        var n, t, r, a, i, c = function (e) {
            var n, t, r, a, i = e.className + " ";
            if (i += e.parentNode ? e.parentNode.className : "", t = l.exec(i)) return S(t[1]) ? t[1] : "no-highlight";
            for (n = 0, r = (i = i.split(/\s+/)).length; n < r; n++) if (o(a = i[n]) || S(a)) return a
        }(e);
        o(c) || (m.useBR ? (n = document.createElementNS("http://www.w3.org/1999/xhtml", "div")).innerHTML = e.innerHTML.replace(/\n/g, "").replace(/<br[ \/]*>/g, "\n") : n = e, i = n.textContent, r = c ? x(c, i, !0) : B(i), (t = g(n)).length && ((a = document.createElementNS("http://www.w3.org/1999/xhtml", "div")).innerHTML = r.value, r.value = d(t, g(a), i)), r.value = M(r.value), e.innerHTML = r.value, e.className = function (e, n, t) {
            var r = n ? u[n] : t, a = [e.trim()];
            return e.match(/\bhljs\b/) || a.push("hljs"), -1 === e.indexOf(r) && a.push(r), a.join(" ").trim()
        }(e.className, c, r.language), e.result = {
            language: r.language,
            re: r.relevance
    ...
    return a.highlight = x, a.highlightAuto = B, a.fixMarkup = M, a.highlightBlock = N, a.configure = function (e) {
        m = s(m, e)
        ...
        var t = b[n] = e(a);
        v(t), t.rawDefinition = e.bind(null, a), t.aliases && t.aliases.forEach(function (e) {
            u[e] = n
        })
    }, a.listLanguages = function () {
        return i(b)
    }, a.getLanguage = S, a.autoDetection = T, a.inherit = s, a.IR = a.IDENT_RE = "[a-zA-Z]\\w*", a.UIR = a.UNDERSCORE_IDENT_RE = "[a-zA-Z_]\\w*", a.NR = a.NUMBER_RE = "\\b\\d+(\\.\\d+)?", a.CNR = a.C_NUMBER_RE = "(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)", a.BNR = a.BINARY_NUMBER_RE = "\\b(0b[01]+)", a.RSR = a.RE_STARTERS_RE = "!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~", a.BE = a.BACKSLASH_ESCAPE = {
        b: "\\\\[\\s\\S]",
        relevance: 0
        ...
        b: a.UIR,
        relevance: 0
    }, a.METHOD_GUARD = {b: "\\.\\s*" + a.UIR, relevance: 0}, a
});
...
hljs.registerLanguage("css", function (e) {
    ...
    return {
        ...
        c: [e.CBCM, {cN: "selector-id", b: /#[A-Za-z0-9_-]+/}, {
            ...
            e: "[{;]",
            i: /:/,
            c: [{cN: "keyword", b: /\w+/}, {b: /\s/, eW: !0, eE: !0, relevance: 0, c: [e.ASM, e.QSM, e.CSSNM]}]
...
hljs.registerLanguage("xml", function (e) {
    ...
    return {
        ...
        c: [{
            ...
            relevance: 10,
            c: [{b: "\\[", e: "\\]"}]
        }, e.C("\x3c!--", "--\x3e", {relevance: 10}), {b: "<\\!\\[CDATA\\[", e: "\\]\\]>", relevance: 10}, {
            cN: "meta",
            b: /<\?xml/,
            e: /\?>/,
            relevance: 10
        ...
        }, {cN: "tag", b: "</?", e: "/?>", c: [{cN: "name", b: /[^\/><\s]+/, relevance: 0}, s]}]
    }
});
...
hljs.registerLanguage("javascript", function (e) {
    var r = "[A-Za-z$_][0-9A-Za-z$_]*", a = {
        ...
        c = {b: "html`", e: "", starts: {e: "`", rE: !1, c: [e.BE, n], sL: "xml"}},
    ...
    return {
        ...
        c: [{cN: "meta", relevance: 10, b: /^\s*['"]use (strict|asm)['"]/}, {
            ...
            b: /^#!/,
            e: /$/
        }, e.ASM, e.QSM, c, s, o, e.CLCM, e.CBCM, t, {
            b: /[{,\n]\s*/,
            relevance: 0,
...
hljs.registerLanguage("cpp", function (e) {
    ...
    return {
        ...
        c: n.concat([i, {
            ...
            k: a,
            i: /[^\w\s\*&]/,
            c: [{b: c, rB: !0, c: [e.TM], relevance: 0}, {
                cN: "params",
                b: /\(/,
                e: /\)/,
                k: a,
                relevance: 0,
                c: [e.CLCM, e.CBCM, r, s, t, {
                    b: /\(/,
                    e: /\)/,
                    k: a,
                    relevance: 0,
